...
function ListingPage1() {
    ...
    return (
        <div className='w-[100%] h-[100vh] bg-white flex items-center justify-center relative overflow-auto'>
            ...
            <form action="" onSubmit={(e)=>{e.preventDefault()
            ...
            } className='max-w-[900px] w-[90%] h-[600px] flex items-center justify-start flex-col md:items-start gap-10 overflow-auto lg:mt-12 mt-[15%] md:mt-[10%] '>
                ...
                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
                    ...
                    <input type="text" id='title' className='w-[90%] h-[40px] border-[2px] border-[#c05050] rounded-lg text-[18px] p-[20px]' required onChange={(e)=>setTitle(e.target.value)} value={title} placeholder='_bhk house or best title'/>
                </div>

                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
                    <label htmlFor="des" className='text-[20px]'>Description</label>
                    <textarea name='' id='des' className='w-[90%] h-[80px] border-[2px] border-[#c05050] rounded-lg text-[18px] p-[20px]' required onChange={(e)=>setDescription(e.target.value)} value={description}/>
                </div>
                ...
                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
                    ...
                    <input type="number" id='rent' className='w-[90%] h-[40px] border-[2px] border-[#c05050] rounded-lg text-[18px] p-[20px]' required onChange={(e)=>setRent(e.target.value)} value={rent} placeholder='_____/day'/>
                </div>
                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
                    <label htmlFor="city" className='text-[20px]'>City</label>
                    <input type="text" id='city' className='w-[90%] h-[40px] border-[2px] border-[#c05050] rounded-lg text-[18px] p-[20px]' required onChange={(e)=>setCity(e.target.value)} value={city} placeholder='City, State'/>
                </div>
                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
                    <label htmlFor="landMark" className='text-[20px]'>LandMark</label>
                    <input type="text" id='landMark' className='w-[90%] h-[40px] border-[2px] border-[#c05050] rounded-lg text-[18px] p-[20px]' required onChange={(e)=>setLandMark(e.target.value)} value={landMark}/>
                </div>
