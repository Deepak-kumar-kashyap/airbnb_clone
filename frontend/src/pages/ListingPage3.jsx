...
function ListingPage3() {
    ...
    return (
        <div className='w-[100%] h-[100vh] bg-white flex flex-col items-center justify-center gap-[10px] overflow-auto relative'>
            <div className='w-[50px] h-[50px] bg-[red] cursor-pointer absolute top-[5%] left-[20px] rounded-[50%] flex items-center justify-center' onClick={() => navigate("/listingpage2")}>
            ...
            <div className='w-[95%] flex items-center justify-start text-[18px] md:w-[80%] md:text-[25px]'>{`${title.toUpperCase()} ${category.toUpperCase()} , ${landMark.toUpperCase()}`}</div>
            <div className='w-[95%] flex items-center justify-start text-[18px] md:w-[80%] md:text-[25px] text-gray-800'>{`${description.toUpperCase()}`}</div>
            <div className='w-[95%] flex items-center justify-start text-[18px] md:w-[80%] md:text-[25px]'>{`Rs.${rent}/day`}</div>

            <div className='w-[95%] h-[50px] flex items-center justify-start px-[110px]'>
                <button className='px-[50px] py-[10px] bg-[#f1291f]  text-[white] text-[18px] md:px-[100px] rounded-lg right-[5%] bottom-[5%] text-nowrap' onClick={handleAddListing} disabled={adding}>{adding ? "adding...": "Add Listing"}</button>
            </div>
